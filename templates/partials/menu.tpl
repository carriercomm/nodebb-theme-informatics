...
<div class="navbar-header page-scroll">
		...
		<a class="page-scroll" href="http://www.informaticslab.co.uk/">
			<img class="navbar-logo" src="http://www.informaticslab.co.uk/img/header.svg" alt="Met Office Logo" />
		</a>
</div>
...
<div class="collapse navbar-collapse navbar-ex1-collapse" id="bs-example-navbar-collapse-1">
		...
		<ul id="main-nav" class="nav navbar-nav navbar-right">
			...
			<li>
				<a href="{relative_path}/" title="[[global:header.home]]">
					<i class="fa fa-fw fa-home"></i><span class="visible-xs-inline"> [[global:header.home]]</span>
				</a>
			</li>
			<!-- IF loggedIn -->
			<li>
